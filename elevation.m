...
%
%   ELEVATION can be called with a LENGTHUNITS string, but GEODETIC2AER
...
%   LENGTHUNITS) uses the string LENGTHUNITS to specify the altitude
...
if strncmpi(angleUnits,'degrees',numel(angleUnits))
